...
player_weekly <- fromJSON("https://fantasy.premierleague.com/drf/element-summary/1")$explain
...
for (i in player_details$id) {
  ...
  dftemp = fromJSON(json_url)$explain
...
write.csv(player_weekly, file="./Data/player_weekly_explain.csv", row.names=FALSE)
